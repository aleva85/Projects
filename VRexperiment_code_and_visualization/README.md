...
![img](spontaneousOBE.png) <!-- .element height="50%" width="50%" -->
![img](spontaneousOBE.png){:height="100px" width="100px"}
Trajectory of the virtual camera during a typical experimental trial
![img](virtualOBE_camera.png) <!-- .element height="50%" width="50%" -->
...
![img](eval.png)    ![img](partial_dep.png)
